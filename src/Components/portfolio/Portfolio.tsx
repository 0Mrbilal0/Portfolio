                ...
                projects.map((projet) => {
                    return (
                        <section className="d-flex flex-column align-items-center">
                            <div className="p-5 text-center m-1 d-flex">
                                ...
                                <section className="d-flex flex-column align-items-center justify-content-center gap-3">
                                    <h1 className="text-body-emphasis">{projet.Titre}</h1>
                                    <p className="col-lg-8 mx-auto fs-5 text-muted">
                                        {projet.Description}
                                    </p>
                                    <div className="d-inline-flex gap-2">
                                        <a className="d-inline-flex align-items-center btn btn-outline-secondary btn-lg px-4 rounded-pill gap-2" href={projet.links.demo} target="_blank">
